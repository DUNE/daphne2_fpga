...
architecture st_xc_arch of st_xc is
    ...
    constant sig_templ: template := (
        ...
        to_signed(integer(-7),14),
        to_signed(integer(-7),14),
        to_signed(integer(-8),14),
        to_signed(integer(-8),14),
        to_signed(integer(-9),14),
        to_signed(integer(-9),14),
        to_signed(integer(-9),14),
        to_signed(integer(-10),14),
        to_signed(integer(-10),14),
        to_signed(integer(-10),14),
        to_signed(integer(-12),14),
        to_signed(integer(-13),14),
        to_signed(integer(-14),14),
        to_signed(integer(-14),14),
        to_signed(integer(-11),14),
        to_signed(integer(-8),14),
        to_signed(integer(-5),14),
